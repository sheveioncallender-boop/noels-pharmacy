...
3. Mark pharmacy products and configure generic name, strength, dosage form, prescription/approval requirements, active ingredients, therapeutic class, register membership, directions, cautions, expiry warning days and low-stock threshold. Native lot/expiry tracking is not required.
...
12. On purchase orders, enter the vendor's expected expiry where known. On the incoming receipt, verify **Actual Expiry** before validation; the Expiry Monitoring record is created automatically.
