...
class PharmacyPatient(models.Model):
    ...
    mobile = fields.Char(
        related="partner_id.phone",
        string="Legacy Mobile Compatibility",
        readonly=False,
        store=True,
        help="Compatibility alias for earlier Noel's Pharmacy releases. The value is stored in Odoo's native contact Phone field.",
    )
